...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        # identify the closest ghost position
        minDist = math.inf
        ...
        for ghostPosition in mostLikelyPositions:
            if self.distancer.getDistance(pacmanPosition, ghostPosition) < minDist:
                ...
                closestGhostPos = ghostPosition
        # choose best action to bring the pacman to the closest ghost
        minDist = math.inf
        bestAction = None
        for action in legal:
            successor = Actions.getSuccessor(pacmanPosition, action)
            if self.distancer.getDistance(successor, closestGhostPos) < minDist:
                minDist = self.distancer.getDistance(successor, closestGhostPos)
                bestAction = action
        return bestAction
